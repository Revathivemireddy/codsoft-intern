...
if _name_ == "_main_":
    ...
    enterTask = Label(gui, text="Enter Your Task", bg="light green", font="bold")
    ...
    TextArea = Text(gui, height=5, width=25, font="italic")
    ...
    # when user press the button, the command or
    # function affiliated to that button is executed .
    delete = Button(gui, text="Delete", fg="Black", bg="Cyan", command=delete)

    # create a Exit Button and place into the root window
    # when user press the button, the command or
    # function affiliated to that button is executed .
    Exit = Button(gui, text="Exit", fg="Black", bg="Cyan", command=exit)
